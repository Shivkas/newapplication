...
<title>Welcome to Registration Page Rinamp Bank.</title>
...
<div class="main_div">
	...
	<div class="page_wrapper">
			...
			<header class="header_div">
				...
				<div class="header_logo">
					<h2>Welcome to Password Reset of Rinamp Bank!!!</h2>
				</div>
			</header>
...
<!-- 	----------------------------------------------------------------------------------------------------- -->		
			...
			<div class="form_field">
				<label>USER ID*</label>
				<input type="text" id="firstname" name="userid" class="name_emp" placeholder="Enter Your Name" autocomplete="off">
			</div>
			<div class="form_field">
				<label>OLD PASSWORD*</label>
				<input type="text" id="name" name="oldpassword" class="name_emp" placeholder="Enter password" autocomplete="off">
			</div>
			<div class="form_field">
				<label>NEW PASSWORD*</label>
				<input type="text" id="name" name="newpassword" class="name_emp" placeholder="Enter new password" autocomplete="off">
			</div>
			<div class="form_field">
